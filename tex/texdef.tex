...
\newcommand{\basise}[1]{\left\{e_{#1}\right\}}
...
\newcommand{\x}{_{x}}
\newcommand{\y}{_{y}}
\newcommand{\sqt}{\dfrac{1}{\sqrt{2}}}
\newcommand{\inp}[1]{\left\langle #1 \right\rangle}
%\newcommand{\ket}[1]{\left| #1 \right\rangle}
\newcommand{\xpv}[1]{\left\langle #1 \right\rangle}
%\newcommand{\ip}[2]{\bra{#1}#2\ket{#1}}
\newcommand{\bb}[1]{\mathbb{#1}}
\def \lskift { \\ \Updownarrow \nonumber \\ }
\def \tia {\tilde{a}}
